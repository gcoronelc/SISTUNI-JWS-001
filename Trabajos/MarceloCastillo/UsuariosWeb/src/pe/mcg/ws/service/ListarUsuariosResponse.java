 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{service.ws.mcg.pe}usuarioEntity" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ListarUsuariosResponse {
    ...
    protected List<UsuarioEntity> _return;
     ...
     * 
     */
    public List<UsuarioEntity> getReturn() {
        if (_return == null) {
            _return = new ArrayList<UsuarioEntity>();
        }
        return this._return;
    }
